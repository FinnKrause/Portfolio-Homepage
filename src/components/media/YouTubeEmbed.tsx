    ...
    >
      {playing ? (
        ...
        >
          ...
          <span className="absolute left-1/2 top-1/2 grid h-10 w-10 -translate-x-1/2 -translate-y-1/2 place-items-center rounded-full bg-white/95 text-brand-700 shadow-lg transition-transform duration-300 group-hover:scale-110">
